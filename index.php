...
<?php echo @$err;?>
        <div class="header-container">
            <p class="large"><span>Never Miss The Recent Notices.</span></p>
            <p class="large">Find yourself,
                <span>in an interesting and interactive discussion</span> from servants of God</p>
...
<div class="thead" id="about">
 ...
 <div class="header-container2">
	<center><p class="large" style="text-align: right;margin-top:-70px;margin-bottom:70px;padding: 10px 10px;width: 110px;border-bottom: 4px solid #5ec9ed"><b>ABOUT</b></p></center>
            <p class="small">We are young Adventist that believes in the three angeles message as indicated in Revelation 14:6-12</p><br>

            <p class="small" style="font-size: 1.3rem;">KCAUSDA is a family that is united under the emblem of Christ abounding love. </p><br>

             <p class="small">Prayerfully together in serve to God and man, we pledge serve faithfully under God's guidance and wisdom.</p>
