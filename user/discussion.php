...
<div class="chatbox">
 <div style="height:80px;">
          <h2><span style="margin-left:10px;">Welcome to Church business board</span><br></h2>
          <span style="font-size:11px; margin-left:10px;padding-bottom:15px;
                border-bottom: 2px solid #e0e0e0;"><i>Note: Avoid using foul language and hate speech to avoid banning of the church</i></span></br>
</div>
...
<br><p style="margin-left: 15px;" id="scroll"><i>&nbsp;&nbsp;Messages End</i></p>
  ...
  <form method="post" action="sendMessage.php">
    ...
    <button style="position: relative;right:140px;top:7px; float:right;background: #2471FF;border: none;padding: 10px 20px 10px 20px;border-bottom: 3px solid #5994FF;border-radius: 5px;color: #D2E2FF;" type="submit" id="send_msg" required />
    Send</button>
